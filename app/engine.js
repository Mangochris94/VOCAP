...
const STR = {
  en:{
    ...
    skinTileGold:'Gold Leaf', skinTileCopper:'Patinated Copper', skinTilePorcelain:'Blue & White Porcelain',
    skinTileSilk:'Woven Silk', skinTileRuby:'Ruby', skinTileMoonstone:'Moonstone',
    skinUnlockAt:'Unlocks at', wordsFound:'words found',
  ...
  th:{
    ...
    skinTileGold:'ทองคำเปลว', skinTileCopper:'ทองแดงสนิมเขียว', skinTilePorcelain:'เครื่องลายคราม',
    skinTileSilk:'ผ้าไหมทอมือ', skinTileRuby:'ทับทิม', skinTileMoonstone:'หินดวงจันทร์',
    skinUnlockAt:'ปลดล็อกที่', wordsFound:'คำที่พบ',
...
const TILE_SKINS = [
  ...
  {id:'copper',     icon:'🪙', nameKey:'skinTileCopper',     need:140},
  {id:'celadon',    icon:'🍵', nameKey:'skinTileCeladon',    need:150},
  {id:'porcelain',  icon:'🫖', nameKey:'skinTilePorcelain',  need:190},
  {id:'batik',      icon:'🧵', nameKey:'skinTileBatik',      need:220},
  {id:'silk',       icon:'🪭', nameKey:'skinTileSilk',       need:280},
  {id:'lacquer',    icon:'🖤', nameKey:'skinTileLacquer',    need:320},
  {id:'ruby',       icon:'♦️', nameKey:'skinTileRuby',       need:380},
  {id:'jade',       icon:'💚', nameKey:'skinTileJade',       need:450},
  {id:'gold',       icon:'👑', nameKey:'skinTileGold',       need:600},
  {id:'moonstone',  icon:'🌙', nameKey:'skinTileMoonstone',  need:750},
];
